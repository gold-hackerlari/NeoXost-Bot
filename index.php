<?php
ob_start();
define('API_KEY','1835710123:AAEgib4y74wYeJdV3Xc5XX0DUQ8X5p9k6d8');
$admin = "953109403";
$promo = "NeoXost_Bot_USS";
$kanall = "@NeoXost_Uz";
$robot = "NeoXost_Bot";
$ver = "9.2.2";
$sayt = "https://u3338.xvest6.ru/NeoXost_Bot/";
function ty($ch){ 
...
$token30 = file_get_contents("$id/token30.txt");
...
$kanal = bot('getChatmember',[
  'chat_id'=>-1001265063988,
  'user_id'=>$id,
  ]);
$kanals = bot('getChatmember',[
  'chat_id'=>-1001363668358,
  'user_id'=>$chatid,
  ]);  
...
if($status == "left"){
  bot('sendMessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"➕ 𝐀'𝐳𝐨 𝐁𝐨ʻ𝐥𝐢𝐬𝐡",'url'=>"https://t.me/GOLD_HACKERLARI"]],
        [['text'=>"➕ 𝐀'𝐳𝐨 𝐁𝐨ʻ𝐥𝐢𝐬𝐡",'url'=>"https://t.me/NeoXost_Uz"]],
...
if($tx == "/start" and $id == $admin){
     bot('sendMessage',[
     'chat_id'=>$id,
     'text'=>"*🤚𝐀𝐬𝐬𝐚𝐥𝐨𝐦𝐮 𝐀𝐥𝐞𝐲𝐤𝐮𝐦 👨‍💻𝐂𝐫𝐞𝐚𝐭𝐨𝐫 @Light_Bloger 𝐌𝐞𝐧𝐠𝐚 𝐗𝐮𝐬𝐡 𝐊𝐞𝐥𝐢𝐛𝐬𝐢𝐳✌️*",
     'parse_mode'=>'markdown',
     'reply_markup'=> $uz,
     ]);
...
file_put_contents("id.dat", "$baza\n$id");
file_put_contents("$id/balance.txt", 100);
}
...
bot('sendMessage',[
    'chat_id'=>$tx[1],
    'text'=>"🎗𝐘𝐚𝐧𝐠𝐢 𝐫𝐞𝐟𝐞𝐫𝐚𝐥. 👤𝐒𝐢𝐳𝐧𝐢𝐧𝐠 𝐇𝐢𝐬𝐨𝐛𝐢𝐧𝐠𝐢𝐳𝐠𝐚 100𝐬𝐨'𝐦 𝐁𝐞𝐫𝐢𝐥𝐝𝐢"
    ]);
...
➖➖➖➖➖➖➖➖➖➖➖➖
✅ 𝐏𝐮𝐥 𝐢𝐬𝐡𝐥𝐚𝐬𝐡 𝐮𝐜𝐡𝐮𝐧 ⤵️ 𝐏𝐚𝐬𝐭𝐝𝐚𝐠𝐢 𝐡𝐚𝐯𝐨𝐥𝐚𝐧𝐢  𝐃𝐨‘𝐬𝐭𝐥𝐚𝐫𝐢𝐧𝐠𝐢𝐳𝐠𝐚 𝐘𝐮𝐛𝐨𝐫𝐢𝐧𝐠 𝐕𝐚 𝐇𝐚𝐫 𝐛𝐢𝐫 𝐃𝐨‘𝐬𝐭𝐢𝐧𝐠𝐢𝐳 𝐮𝐜𝐡𝐮𝐧 100 𝐬𝐨'𝐦𝐝𝐚𝐧 𝐎𝐥𝐢𝐧𝐠.
➖➖➖➖➖➖➖➖➖➖➖➖
✅ 30 𝐭𝐚 𝐃𝐨‘𝐬𝐭𝐢𝐧𝐠𝐢𝐳𝐧𝐢 𝐓𝐚𝐤𝐥𝐢𝐟 𝐪𝐢𝐥𝐢𝐛 𝐁𝐢𝐫 𝐎𝐲𝐥𝐢𝐤 💸 𝐓𝐨‘𝐥𝐨𝐯𝐧𝐢 𝐓𝐞𝐤𝐢𝐧𝐠𝐚 𝐓𝐨‘𝐥𝐚𝐧𝐠
➖➖➖➖➖➖➖➖➖➖➖➖",
'reply_markup'=>json_encode([
  'inline_keyboard'=>[
    [['text'=>"♻️𝐃𝐨'𝐬𝐭𝐥𝐚𝐫𝐠𝐚 𝐘𝐮𝐛𝐨𝐫𝐢𝐬𝐡",'url'=>"https://telegram.me/share/url?url=@$robot orqali Php Dasturlash Tilida botlar yarating va Pul ishlang. Botga Kiring va O'z Botingizni yarating. Kirish uchun ⬇️ ni ustiga bosing ⤵️⤵️⤵️
➖➖➖➖➖➖➖➖➖➖➖➖
...
$token30 = file_get_contents("$tx[1]/token30.txt");
...
$b30 = json_decode(file_get_contents("https://api.telegram.org/bot$token30/getMe"));
$bid30 = $b30->result->id;
$botname30 = $b30->result->first_name;
$c30 = $b30->result->username;
$res = "--------1-------
🆔 𝐁𝐨𝐭 𝐈𝐃 𝐬𝐢: $bid
📝 𝐁𝐨𝐭 𝐍𝐨𝐦𝐢: $botname
❇️ 𝐁𝐨𝐭 𝐔𝐬𝐞𝐫𝐢: @$c
...
➖➖➖➖➖➖➖➖➖➖➖➖
🤞𝐌𝐚𝐫𝐡𝐚𝐦𝐚𝐭, 🔐𝐏𝐫𝐨𝐦𝐨𝐤𝐨𝐝 𝐧𝐢 𝐊𝐢𝐫𝐢𝐭𝐢𝐧𝐠 𝐯𝐚 💰4000 𝐒𝐨‘𝐦𝐠𝐚 𝐄𝐠𝐚 𝐛𝐨‘𝐥𝐢𝐧𝐠✅.
➖➖➖➖➖➖➖➖➖➖➖➖",
    'parse_mode'=>"markdown",
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"🔐𝐏𝐫𝐨𝐦𝐨𝐤𝐨𝐝𝐧𝐢 𝐎𝐥𝐢𝐬𝐡",'url'=>"https://t.me/StudioUlmasSHox"]]
        ]
      ])
    ]);
}
...
➖➖➖➖➖➖➖➖➖➖➖➖
📣 𝐊𝐚𝐧𝐚𝐥𝐢𝐦𝐢𝐳: @GOLD_HACKERLARI
➖➖➖➖➖➖➖➖➖➖➖➖
👨‍💻 𝐀𝐝𝐦𝐢𝐧: @StudioUlmasSHox
➖➖➖➖➖➖➖➖➖➖➖➖*",
     'parse_mode'=>'markdown',
       'reply_markup'=> $uz,
     ]);
...
➖➖➖➖➖➖➖➖➖➖➖➖",
    'reply_markup'=>json_encode([
  'inline_keyboard'=>[
    [['text'=>"💰𝐇𝐢𝐬𝐨𝐛𝐧𝐢 𝐓𝐨‘𝐥𝐝𝐢𝐫𝐢𝐬𝐡", 'callback_data'=>"oplata_uzb"]]
    ]
  ])
    ]);
}
}
if($tx >=1 and $tx <=30 and $tx !="🔙 𝐎𝐫𝐪𝐚𝐠𝐚" and $step == "slot" and $langue == "uz"){
  bot('sendMessage',[
'chat_id'=>$id,
...
$okey = file_put_contents("$id/bots/bot$stol/$id.code.$type",file_get_contents($file));
  ...
  send($id, "📄 𝐅𝐚𝐲𝐥𝐝𝐚 𝐞𝐧𝐠 𝐭𝐚𝐪𝐢𝐪𝐥𝐚𝐧𝐠𝐚𝐧 𝐤𝐨𝐝𝐥𝐚𝐫 𝐛𝐨𝐫
➖➖➖➖➖➖➖➖➖➖➖➖
...
➖➖➖➖➖➖➖➖➖➖➖➖</b>");
  ...
  'caption'=>"🖖𝐀𝐬𝐬𝐚𝐥𝐨𝐦𝐮 𝐀𝐥𝐞𝐲𝐤𝐮𝐦 𝐀𝐝𝐦𝐢𝐧 𝐉𝐚𝐧𝐨𝐛𝐥𝐚𝐫𝐢 !
➖➖➖➖➖➖➖➖➖➖➖➖
...
if($tx >=1 and $tx <=30 and $step == "del" and $langue == "uz"){
file_put_contents("$id/slot.txt", $tx);
$stol = file_get_contents("$id/slot.txt");
...
if($tx == "📣 𝐊𝐚𝐧𝐚𝐥𝐢𝐦𝐢𝐳"){
     bot('sendMessage',[
     'chat_id'=>$id,
     'text'=>"*📣 𝐁𝐢𝐳𝐧𝐢𝐧𝐠 𝐇𝐨𝐦𝐢𝐲 𝐯𝐚 𝐑𝐚𝐬𝐦𝐢𝐲 𝐊𝐚𝐧𝐚𝐥𝐢𝐦𝐢𝐳: @GOLD_HACKERLARI
➖➖➖➖➖➖➖➖➖➖➖➖
...
📝 𝐁𝐨𝐭𝐢𝐧𝐠𝐢𝐳 𝐍𝐨𝐦𝐢: $botname26
❇️ 𝐁𝐨𝐭𝐢𝐧𝐠𝐢𝐳 𝐔𝐬𝐞𝐫𝐢: @$c26
➖➖➖➖➖➖➖➖➖➖➖➖
--------27-------
🆔 𝐁𝐨𝐭𝐢𝐧𝐠𝐢𝐳 𝐈𝐃 𝐬𝐢: $bid27
...
🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥🟥
➖➖➖➖➖➖➖➖➖➖➖➖
𝐇𝐨𝐬𝐭𝐢𝐧𝐠 𝐁𝐨𝐭𝐥𝐚𝐫 𝐔𝐥𝐚𝐬𝐡 𝐌𝐮𝐦𝐤𝐢𝐧 𝐄𝐦𝐚𝐬
➖➖➖➖➖➖➖➖➖➖➖➖
♋️ 𝐒𝐡𝐞𝐥𝐥 𝐊𝐨𝐝𝐥𝐚𝐫 𝐔𝐥𝐚𝐬𝐡𝐠𝐚 ⚠️𝐔𝐫𝐮𝐧𝐦𝐚𝐧𝐠, ??𝐯𝐭𝐨𝐦𝐚𝐭𝐢𝐤 🚫𝐁𝐥𝐨𝐜𝐤 𝐁𝐨'𝐥𝐚𝐬𝐢𝐳
➖➖➖➖➖➖➖➖➖➖➖➖
...
if($data == "oplata_uzb"){
    ...
    'message_id'=>$mid,
    'text'=>"➖➖➖➖➖➖➖➖➖➖➖➖
💰𝗧𝗼‘𝗹𝗼𝘃 𝗧𝘂𝗿𝗹𝗮𝗿𝗶: 🔵𝐂𝐋𝐈𝐂𝐊, 🟣𝐏𝐀𝐘𝐌𝐄 🟢𝐏𝐀𝐘𝐍𝐄𝐓.
➖➖➖➖➖➖➖➖➖➖➖➖
💵𝐓𝐨‘𝐥𝐨𝐯𝐧𝐢 𝐓𝐨‘𝐥𝐚𝐬𝐡 𝐔𝐜𝐡𝐮𝐧 @StudioUlmasSHox 𝐠𝐚 📝𝐘𝐨𝐳𝐢𝐧𝐠 𝐯𝐚 𝐓𝐨'𝐥𝐨𝐯 𝐓𝐮𝐫𝐢𝐧𝐢 𝐓𝐚𝐧𝐥𝐚𝐛 𝐓𝐨‘𝐥𝐚𝐧𝐠.

➖➖➖➖➖➖➖➖➖➖➖➖

💵 𝐏𝐮𝐥 𝐌𝐮𝐯𝐚𝐟𝐟𝐚𝐪𝐢𝐲𝐚𝐭𝐥𝐢 𝐓𝐨'𝐥𝐚𝐧𝐠𝐚𝐧𝐝𝐚𝐧 𝐒𝐨'𝐧𝐠 𝐀𝐯𝐭𝐨𝐦𝐚𝐭𝐢𝐤 𝐓𝐚𝐫𝐳𝐝𝐚 💰𝐁𝐚𝐥𝐚𝐧𝐬𝐢𝐧𝐠𝐢𝐳𝐠𝐚 𝐎'𝐭𝐤𝐚𝐳𝐢𝐥𝐚𝐝𝐢.
➖➖➖➖➖➖➖➖➖➖➖➖
🟣 𝐏𝐀𝐘𝐌𝐄: 2505 0139 3225 7420
➖➖➖➖➖➖➖➖➖➖➖➖
🔵 𝐂𝐋𝐈𝐂𝐊: 8800 8042 1086 8330
➖➖➖➖➖➖➖➖➖➖➖➖
🟢 𝐏𝐀𝐘𝐍𝐄𝐓: +998 91 454 77 90
➖➖➖➖➖➖➖➖➖➖➖➖",
'parse_mode'=>"markdown",
'reply_markup'=>json_encode([
  'inline_keyboard'=>[
    [['text'=>"💰𝐓𝐨‘𝐥𝐚𝐬𝐡", 'url'=>"https://t.me/StudioUlmasSHox"]],[['text'=>"🔐𝐏𝐫𝐨𝐦𝐨𝐤𝐨𝐝 𝐊𝐢𝐫𝐢𝐭𝐢𝐬𝐡", 'callback_data'=>"promokod"]]
    ]
  ])]);
...
➖➖➖➖➖➖➖➖➖➖➖➖
👤𝐒𝐢𝐳𝐧𝐢𝐧𝐠 𝐇𝐢𝐬𝐨𝐛𝐢𝐧𝐠𝐢𝐳𝐠𝐚 💰4000𝐬𝐨'𝐦 𝐐𝐨‘𝐬𝐡𝐢𝐥𝐝𝐢 ✅
➖➖➖➖➖➖➖➖➖➖➖➖");
}}

$Light_Bloger = "953109403";
$text = $update->message->text;
$chat_id = $update->message->chat->id;

if($text == '🗃 𝐁𝐨𝐭𝐢𝐦𝐢𝐳 𝐊𝐨𝐝𝐢' and $chat_id == $Light_Bloger){
bot('sendDocument',[
'chat_id'=>$chat_id,
